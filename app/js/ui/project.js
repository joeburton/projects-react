    ...
    render() {
        return (
            <li className="project">
                ...
                <p className='link'> <a href={this.props.project.link} target='_blank'>{this.props.project.link}</a></p>
                <p className='skills'> {this.props.project.skills}</p>
                <p className='description'> {this.props.project.description}</p>
                {this.props.loggedin &&
                    <div className="admin-controls">
                        <a className="btn btn-outline-success my-2 my-sm-0 btn-edit" href='#' onClick={this.getCompanyProjectId}>EDIT</a>
                        <a className="btn btn-outline-danger my-2 my-sm-0" href='#' onClick={this.deleteProject}>DELETE</a>
                    </div>
                }
            </li>
        )
